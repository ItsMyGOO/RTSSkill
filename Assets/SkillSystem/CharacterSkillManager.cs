...
namespace RTSSkill
{
    public class CharacterSkillManager : MonoBehaviour
    {
        ...
        //生成技能
        public void GenerateSkill(SkillData data, IGameObjectCreator gameObjectPool)
        {
            //创建技能预制体
            GameObject skillgo = gameObjectPool.CreateGameObject(data.prefabName, data.skillPrefab, transform.position, transform.rotation);
            //传递技能数据给技能释放器
